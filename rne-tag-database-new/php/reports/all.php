<?php
	...
	$sql = "SELECT * FROM `tags` WHERE `subproject`" . (isset($_SESSION[$PRJ_SUB]) ? " = " .$_SESSION[$PRJ_SUB] : " LIKE '%'") . $REPORT_ALL_FILTER; 
...
<div class="jumbotron device-info-jumbotron" style="width:100%; padding:0">
	<div class="container" style="width:100%">
		...
		<div class="row">
			<div class="col-xs-6">
				<h2><?php echo strtoupper($_SESSION[$PRJ] . ( isset($_SESSION[$PRJ_SUB]) ? $_SESSION[$PRJ_SUB] : "" )); ?> - All Tags </h2>
			</div> <!-- /.col -->
