<?php
	...
	$sql = "SELECT * FROM `tags` WHERE `subproject`" . (isset($_SESSION[$PRJ_SUB]) ? " = " .$_SESSION[$PRJ_SUB] : " LIKE '%'") . $REPORT_REMAINING_FILTER; 
...
<div class="jumbotron device-info-jumbotron" style="width:100%; padding:0">
	<div class="container" style="width:100%">
		...
		<div class="row">
			<div class="col-xs-6">
				<h2><?php echo strtoupper($_SESSION[$PRJ] . ( isset($_SESSION[$PRJ_SUB]) ? $_SESSION[$PRJ_SUB] : "" )); ?> - Remaining Tags </h2>
			</div> <!-- /.col -->
		...
		<div style="width:100%">
			...
			<table id="table-custom-sort" class="table table-sm table-bordered table-hover table-condensed sortable" style="width:100%">
				...
				<tbody>
					...
					?>
							<tr class="<?php echo ($row['deleted'] <> 0 ? 'danger' : ($row['completed'] <> 0 ? 'success' : 'warning' )); ?> small" style="cursor: pointer" 
							data-toggle="modal" 
